...
import art from "../img/arte-competitivo.png"
//animation
    ...
    <div className="wrapper competitivo">
      <section className="intro">
        <div className="headlines-wrapper">
          <h2>COMPETITIVO</h2>
          <p>
            Mergulhe no mundo dos jogos competitivos e domine seus adversários
            com poder, velocidade e desempenho como nunca antes visto.
          </p>
        </div>
      ...
      <section className="performance">
        <div className="bullets-wrapper">
          ...
          <ul>
            <li>
              Jogos de nível competitivo: Poder para jogar com a configuração
              mais exigente.{" "}
            </li>
